...
const HollywoodPage = () => {
  ...
  return (
    <div className="bg-[#181818] w-full min-h-screen">
      <Helmet>
        <title>Hollywood Movies | LazyFlix</title>
        <meta name="description" content="Discover the latest Hollywood movies, trailers, and more." />
        <meta property="og:title" content="Hollywood Movies | LazyFlix" />
        <meta property="og:description" content="Discover the latest Hollywood movies, trailers, and more." />
        <meta property="og:image" content="https://lazycodwr.github.io/LazyFlix/assets/images/logo.png" />
        <meta property="og:url" content="https://lazycodwr.github.io/LazyFlix/" />
      ...
      <section className="w-full h-1/2 py-28 text-[#818083] pl-10 max-[599px]:pl-4">
        <div className="btm h-full w-full ">
          <div className=".txt flex items-center justify-start gap-2 mb-6">
            ...
            <h4 className="font-[bold] text-white text-xl">Hollywood</h4>
          </div>
        </div>
        ...
        <div className="movies-container flex items-start justify-start flex-wrap gap-3">
          {data
            ...
            .map((value, index) => (
              <div
                className="card w-[11vw] cursor-pointer max-[599px]:w-[29vw] h-[16vw] max-[599px]:h-[25vh] rounded overflow-hidden relative"
                key={index}
                onClick={(name)=>handlemovie(value.movieName)}
              >
                <img
                  className="w-full h-full bg-cover"
                  src={value.bannerSmall}
                  alt=""
                />
                ...
                <div className="info w-full h-full absolute top-0 left-0 text-white p-2 flex items-start justify-between flex-col">
                  <span className="font-[regular] text-[0.8vw] font-semibold rounded-full bg-[#CDD7DA] text-black px-2 max-[599px]:text-[2.5vw]">
                    {value.releaseYear}
                  </span>
