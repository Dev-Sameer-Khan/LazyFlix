  ...
  return (
     <section className='w-full h-1/2 my-10 text-[#818083] pl-10 max-[599px]:pl-4'>
            ...
            <div className='.txt flex items-center justify-start gap-2 mb-6'>
                ...
                <h4 className='font-[bold] text-white text-xl'>Punjabi Movies</h4>
                <Link to="/punjabi"><div className='px-[6px] py-[2px] rounded-full text-white text-[0.85vw] max-[599px]:text-[3vw] bg-red-700'>View more</div></Link>
            </div>
            
            </div>
            
            <div className="movies-container flex items-start justify-start flex-wrap gap-3">
            {data.filter(movie => movie.category === 'Punjabi').map((value,index)=>(
